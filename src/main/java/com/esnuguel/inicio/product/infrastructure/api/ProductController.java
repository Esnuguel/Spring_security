...
public class ProductController implements ProductApi {
    ...
    public ResponseEntity<PaginationResult<ProductDto>> getAllProducts(
        ...
        PaginationQuery paginationQuery=new PaginationQuery(pageNumber, pageSize, sortBy, sortDirection);
        GetAllProductRequest getAllProductRequest=new GetAllProductRequest(paginationQuery, new ProductFilter(name, description, minPrice, maxPrice));
